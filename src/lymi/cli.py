...
from lymi.bench.runner import run_task
...
from lymi.providers.claude_code import ClaudeCodeAuthError
...
def bench(
    ...
    except LocalTimeoutError as exc:
        # Tampoco es un fallo del programa: el servidor local se quedo mudo.
        typer.secho(f"\n  {exc}", fg=typer.colors.YELLOW)
        raise typer.Exit(1) from None
    finally:
        ledger.close()
